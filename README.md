...
[![Latest Version on NPM](https://img.shields.io/npm/v/@imaginativeimpact/inertiajs-tables-laravel-query-builder.svg?style=flat-square)](https://npmjs.com/package/@imaginativeimpact/inertiajs-tables-laravel-query-builder)
[![npm](https://img.shields.io/npm/dt/@imaginativeimpact/inertiajs-tables-laravel-query-builder.svg?style=flat-square)](https://www.npmjs.com/package/@imaginativeimpact/inertiajs-tables-laravel-query-builder)
[![Latest Version on Packagist](https://img.shields.io/packagist/v/imaginativeimpact/inertiajs-tables-laravel-query-builder.svg?style=flat-square)](https://packagist.org/packages/imaginativeimpact/inertiajs-tables-laravel-query-builder)
[![Total Downloads](https://img.shields.io/packagist/dt/imaginativeimpact/inertiajs-tables-laravel-query-builder.svg?style=flat-square)](https://packagist.org/packages/imaginativeimpact/inertiajs-tables-laravel-query-builder)
...
![Inertia.js Table for Laravel Query Builder](https://github.com/ImaginativeImpact/inertiajs-tables-laravel-query-builder/assets/50271531/eae08bad-fc11-48b7-a5f2-9268df04c947)
...
```bash
composer require imaginativeimpact/inertiajs-tables-laravel-query-builder
```
...
```bash
npm install @imaginativeimpact/inertiajs-tables-laravel-query-builder --save

yarn add @imaginativeimpact/inertiajs-tables-laravel-query-builder
```
...
module.exports = {
  content: [
    './node_modules/@imaginativeimpact/inertiajs-tables-laravel-query-builder/**/*.{js,vue}',
  ]
}
```
...
```vue
<script setup>
import { Table } from "@imaginativeimpact/inertiajs-tables-laravel-query-builder";
...
```js
import { setTranslations } from "@imaginativeimpact/inertiajs-tables-laravel-query-builder";
...
* When using a custom `thead` or `tbody` slot, you need to provide [the styling](https://github.com/imaginativeimpact/inertiajs-tables-laravel-query-builder/blob/c8e21649ad372d309eeb62a8f771aa4c7cd0089e/js/Tailwind2/Table.vue#L1) manually.
